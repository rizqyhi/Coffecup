		...
		<section id="content">
			...
			<form action="" method="post" id="new-post">
				<div class="columns eight">
					...
					<input type="text" name="post-created" id="post-created">
				</div>

				<div class="columns eight">
					<label for="post-description">Description</label>
					<textarea id="post-description" name="post-description" rows="5"></textarea>
				</div>
				<div class="clearfix"></div>

				<div class="columns eight">
					<label for="post-html">Content</label>
					<textarea id="post-html" name="post-html" rows="10"></textarea>
				</div>

				<div class="columns eight">
					<label for="post-css">Your custom CSS</label>
					<textarea id="post-css" name="post-css" rows="10"></textarea>
				</div>
				<div class="clearfix"></div>
				...
				<div id="submit-options">
					<div class="container">
						<div class="columns eight">
							...
							<a href="<?php echo $this->location('admin/posts'); ?>" class="cancel">Cancel</a>
						</div>
						<div class="columns eight">
							<label for="post-status"><input type="checkbox" name="post-status" value="true"> Draft</label>
						</div>
					</div>
				</div>
			</form>
